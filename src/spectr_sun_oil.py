...
dir_d1 = dir
Data1 = {}
#wl = np.loadtxt(join(dir_d1,listdir(dir_d1)[0]),skiprows = 15, usecols = 0, comments='>')
...
for itm in natural_sort(listdir(dir_d1)):
    if itm.endswith(".txt"):
        #Data1[itm] = np.loadtxt(join(dir_d1,itm), skiprows=15,usecols = 1, comments='>')
